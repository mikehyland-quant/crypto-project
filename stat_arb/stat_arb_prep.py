...
# ============================================================
    ...
    input_file = 'prices_' + suffix + '.csv'
    file_path = Path("stat_arb/prices") / input_file
...
# ============================================================
    ...
    # price ratio moving avgs
    for ratio_name in ratio_name_list:
        df[f"{ratio_name}_moving_avg"] = df[f"{ratio_name}"].rolling(window=moving_avg_window, 
                                                                    min_periods=moving_avg_window).mean()
